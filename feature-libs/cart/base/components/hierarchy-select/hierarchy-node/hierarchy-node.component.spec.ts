...
describe('HierarchyNodeComponent', () => {
	...
	beforeEach(() => {
		fixture = TestBed.createComponent<HierarchyNodeComponent<void>>(HierarchyNodeComponent);
	...
	describe('seting the type on init', () => {
		it('should set NODE for null', () => {
			component.ngOnInit();

			expect(component.type).toEqual('NODE');
		});

		it('should set NODE for HierarchyNode', () => {
			component.tree = new HierarchyNode();
